...
ECHO  FullTrust(TimerJob) RI Installation is in progress....
ECHO  ======================================================
...
ECHO Build FullTrust Solution in process... > RIInstall.log
ECHO Build FullTrust Solution in process... 
 call MSBUild.exe "..\ExecutionModels.FarmSolution.sln" /t:build  >> RIInstall.log

	IF %Errorlevel% == 1 goto buildfailed
ECHO Package FullTrust Solution in Process....
ECHO Package FullTrust Solution in Process....>> RIInstall.log
 call MSBUild.exe "..\ExecutionModels.FarmSolution.sln" /t:build /p:IsPackaging=true >>RIInstall.log
...
ECHO Build Sandboxed Solution in process... 
