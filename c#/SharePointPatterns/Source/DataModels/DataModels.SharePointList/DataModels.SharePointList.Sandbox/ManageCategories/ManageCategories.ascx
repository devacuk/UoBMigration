...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ManageCategories.ascx.cs" Inherits="DataModels.SharePointList.Sandbox.ManageCategories.ManageCategories" %>
    ...
    <tr>
        ...
        <asp:gridview runat="server" ID="CategoryResultsGridView" 
            ...
            <asp:BoundField DataField="CategoryId" Visible="False"></asp:BoundField>
                <asp:TemplateField HeaderText="Category Name"><ItemTemplate><asp:HyperLink ID="CategoryNameHyperLink" runat="server" NavigateUrl="" 
                            Text='<%# Eval("CategoryName") %>'></asp:HyperLink></ItemTemplate></asp:TemplateField>
                 <asp:ButtonField CommandName="Select" HeaderText="Machines" Text="Machines"></asp:ButtonField>
            </Columns>
