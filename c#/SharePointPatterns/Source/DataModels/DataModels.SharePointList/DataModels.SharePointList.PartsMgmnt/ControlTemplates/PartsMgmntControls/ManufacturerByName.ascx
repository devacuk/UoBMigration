...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ManufacturerByName.ascx.cs" Inherits="DataModels.SharePointList.PartsMgmnt.PartsMgmntControls.ManufacturerByName" %>
<table width="100%">
    <tr>
        <td colspan="2">
