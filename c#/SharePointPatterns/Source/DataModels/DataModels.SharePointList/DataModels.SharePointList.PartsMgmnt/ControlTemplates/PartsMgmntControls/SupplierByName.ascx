...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SupplierByName.ascx.cs" Inherits="DataModels.SharePointList.PartsMgmnt.PartsMgmntControls.SupplierByName" %>
<table width="100%">
    <tr>
        <td colspan="2">
