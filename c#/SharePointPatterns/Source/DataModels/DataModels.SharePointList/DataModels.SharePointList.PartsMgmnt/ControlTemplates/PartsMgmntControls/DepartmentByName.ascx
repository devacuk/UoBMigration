...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DepartmentByName.ascx.cs" Inherits="DataModels.SharePointList.PartsMgmnt.PartsMgmntControls.DepartmentByName" %>
<table width="100%">
    <tr>
        <td colspan="2">
