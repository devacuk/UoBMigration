...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ManageMachines.ascx.cs" Inherits="DataModels.SharePointList.PartsMgmnt.PartsMgmntControls.ManageMachines" %>
