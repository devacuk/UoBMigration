<#  
    .SYNOPSIS
    this works this is the step after provisioning to add secondary admin to personal sites
    .DESCRIPTION
    grants admin access to folks onedrives which isnt default behaviour
    .EXAMPLE
    TODO e.g. MigrateUsersMysitesToOneDrives.ps1 -onPremiseMyonedriveURIPart "https://xxx.xxxxxx.ac.uk/user" -o365OnedriveURIPart "https://xxxxxx-my.sharepoint.com/personal" -sourcePasswordPlain "xxxxxxxxxx" -destinationPasswordPlain "xxxxxxxxx" -onPremiseAdministratorAdminAccount  "UNIVERSITY\xxxxxx" -o365AdminAccount "admin@xxxxxxxx.onmicrosoft.com" -destinationListName "Documents" -sourceListName "MyFiles"
    .NOTES
    Author : Tristian O'Brien - t.xxx@xxxxxx.ac.uk
    Version:        1.0
    Creation Date:  20th October 2017
    Purpose/Change: University of xxxxxx OneDrive migrations
    .LINK
